...
<h3 align="center">An Experienced Software Engineer from Nepal</h3>
...
<h4> ASP.NET Core, ASP.NET MVC, RESTful APIs, C#, JS, ReactJS, AngularJS, SQL, NoSQL, Docker, Azure, AWS.</h4>
